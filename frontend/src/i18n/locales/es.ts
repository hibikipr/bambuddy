export default {
  ...
  settings: {
    ...
    barcodeScan: {
      title: 'Búsqueda de código de barras para agregar',
      enableLookup: 'Buscar códigos de barras escaneados en línea',
      enableLookupDesc: 'Consulta la Open Filament Database y SpoolmanDB-Community de la comunidad cuando un código de barras escaneado aún no está en tu inventario. Desactívalo para solo coincidir con códigos ya escaneados antes — el escaneo en sí siempre sigue funcionando.',
      refreshNow: 'Actualizar base de datos ahora',
      databaseRefreshed: 'Open Filament Database actualizada — {{count}} códigos de barras disponibles',
      databaseRefreshFailed: 'Error al actualizar la Open Filament Database',
    },
    ...
    colorCatalog: {
      ...
      syncSpoolmanDbCommunity: 'SpoolmanDB-Community',
      syncSpoolmanDbCommunityTooltip: 'Sincronizar desde SpoolmanDB-Community (más de 430 marcas, puede tardar un minuto)',
  ...
  inventory: {
    ...
    barcodeScan: {
      ...
      tabScan: 'Escanear',
      tabPhoto: 'Foto de la etiqueta',
      tabManual: 'Entrada manual',
      scanHint: 'Alinea el código de barras dentro del recuadro',
      cameraNeedsHttps: 'Cámara no disponible — se requiere HTTPS (o localhost). Usa Foto de la etiqueta o Entrada manual en su lugar.',
      cameraError: 'Cámara no disponible ({{error}}). Si Bambuddy no se sirve por HTTPS, esto es normal — usa Foto de la etiqueta o Entrada manual en su lugar.',
      photoHint: 'Toma o elige una foto de la etiqueta del carrete — funciona incluso sin soporte de escaneo por cámara.',
      takePhoto: 'Tomar foto',
      choosePhoto: 'Elegir foto',
      manualHint: 'Escribe el código de barras o el SKU/número de artículo impreso en la caja del carrete',
      manualPlaceholder: 'p. ej. 6938936716785',
      manualInvalid: 'Introduce un código UPC-A/EAN-8/EAN-13 válido, o un SKU/número de artículo del fabricante (3 o más caracteres)',
      lookUp: 'Buscar',
      lookingUp: 'Buscando código de barras…',
      sourceInventory: 'tu inventario',
      sourceOfd: 'la Open Filament Database',
      sourceSpoolmanDbCommunity: 'SpoolmanDB-Community',
      matchedToast: 'Coincidencia encontrada en {{source}}',
      noMatchToast: 'No se encontró coincidencia — completa los detalles manualmente',
      lookupFailed: 'Error al buscar el código de barras',
      ocrReading: 'Leyendo etiqueta…',
      ocrProgress: 'Leyendo etiqueta… {{progress}}',
      ocrNoText: 'No se encontró texto — prueba con una foto más clara y cercana.',
      parsingLabel: 'Analizando etiqueta…',
      guessedToast: 'Detalles estimados a partir de la etiqueta — revísalos',
      ocrFailed: 'Error al leer la etiqueta',
    },
    ...
    barcodePlaceholder: 'p. ej. 6938936716785',
    barcodeHelp: 'Se completa automáticamente con Escanear código de barras. Ingresa uno manualmente para que un futuro escaneo del mismo código coincida al instante con esta bobina.',
    linkedCodesLabel: 'También coincide con: {{codes}}',
    linkedCodesRefill: 'recarga',
