export default {
  ...
  settings: {
    ...
    barcodeScan: {
      title: '掃描新增條碼查詢',
      enableLookup: '線上查詢已掃描的條碼',
      enableLookupDesc: '當掃描的條碼尚未存在於您的庫存中時，查詢社群維護的 Open Filament Database 和 SpoolmanDB-Community。關閉後僅比對您先前掃描過的條碼——掃描功能本身一律可用。',
      refreshNow: '立即重新整理資料庫',
      databaseRefreshed: 'Open Filament Database 已重新整理——現有 {{count}} 個條碼',
      databaseRefreshFailed: '重新整理 Open Filament Database 失敗',
    },
    ...
    colorCatalog: {
      ...
      syncSpoolmanDbCommunityTooltip: '從 SpoolmanDB-Community 同步（430+ 個品牌，可能需要一分鐘）',
      loadFailed: '載入顏色目錄失敗',
  ...
  inventory: {
    ...
    barcodeScan: {
      ...
      takePhoto: '拍照',
      choosePhoto: '選擇照片',
      manualHint: '輸入料盤包裝上印製的條碼或製造商 SKU/貨號',
      manualPlaceholder: '例如 6938936716785',
      manualInvalid: '請輸入有效的 UPC-A、EAN-8 或 EAN-13 條碼，或製造商 SKU/貨號（至少 3 個字元）',
      lookUp: '查詢',
      lookingUp: '正在查詢條碼…',
      sourceInventory: '您的庫存',
      sourceOfd: 'Open Filament Database',
      sourceSpoolmanDbCommunity: 'SpoolmanDB-Community',
      matchedToast: '已從{{source}}找到符合項目',
      noMatchToast: '找不到符合項目——請手動填寫詳細資料',
      lookupFailed: '條碼查詢失敗',
      ocrReading: '正在讀取標籤…',
      ocrProgress: '正在讀取標籤… {{progress}}',
      ocrNoText: '找不到文字——請嘗試更清晰、更近的照片。',
      parsingLabel: '正在解析標籤…',
      guessedToast: '已根據標籤推測詳細資料——請確認',
      ocrFailed: '讀取標籤失敗',
    },
    addSpool: '新增耗材',
    editSpool: '編輯耗材',
    ...
    barcodeHelp: '由「掃描條碼」自動填寫。也可手動輸入，以便日後再次掃描相同條碼時立即比對到此料盤。',
    linkedCodesLabel: '同時符合：{{codes}}',
    linkedCodesRefill: '補充包',
