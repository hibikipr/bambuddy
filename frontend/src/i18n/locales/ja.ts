export default {
  ...
  settings: {
    ...
    barcodeScan: {
      title: 'スキャンして追加 バーコード検索',
      enableLookup: 'スキャンしたバーコードをオンラインで検索',
      enableLookupDesc: 'スキャンしたバーコードがまだ在庫にない場合、コミュニティのOpen Filament DatabaseとSpoolmanDB-Communityを照会します。オフにすると、以前にスキャンしたバーコードのみと照合します — スキャン機能自体は常に動作します。',
      refreshNow: '今すぐデータベースを更新',
      databaseRefreshed: 'Open Filament Databaseを更新しました — {{count}}件のバーコードが利用可能',
      databaseRefreshFailed: 'Open Filament Databaseの更新に失敗しました',
    },
    ...
    colorCatalog: {
      ...
      syncSpoolmanDbCommunityTooltip: 'SpoolmanDB-Communityから同期（430+ブランド）',
  ...
  inventory: {
    ...
    barcodeScan: {
      ...
      takePhoto: '写真を撮る',
      choosePhoto: '写真を選択',
      manualHint: 'スプール箱に印刷されたバーコードまたはメーカーのSKU/型番を入力してください',
      manualPlaceholder: '例: 6938936716785',
      manualInvalid: '有効なUPC-A/EAN-8/EAN-13のバーコード、またはメーカーのSKU/型番（3文字以上）を入力してください',
      lookUp: '検索',
      lookingUp: 'バーコードを検索しています…',
      sourceInventory: '在庫データ',
      sourceOfd: 'Open Filament Database',
      sourceSpoolmanDbCommunity: 'SpoolmanDB-Community',
      matchedToast: '{{source}}から一致しました',
      noMatchToast: '一致するデータが見つかりませんでした — 詳細を手動で入力してください',
      lookupFailed: 'バーコードの検索に失敗しました',
      ocrReading: 'ラベルを読み取っています…',
      ocrProgress: 'ラベルを読み取っています… {{progress}}',
      ocrNoText: 'テキストが見つかりませんでした — より鮮明で近い写真を試してください。',
      parsingLabel: 'ラベルを解析しています…',
      guessedToast: 'ラベルから詳細を推測しました — 内容を確認してください',
      ocrFailed: 'ラベルの読み取りに失敗しました',
    },
    addSpool: 'スプールを追加',
    editSpool: 'スプールを編集',
    copySpool: 'スプールをコピー',
    ...
    costPerKg: 'kgあたりのコスト',
    barcode: 'バーコード',
    barcodePlaceholder: '例: 6938936716785',
    barcodeHelp: 'バーコードをスキャンで自動的に入力されます。手動で入力しておくと、同じコードを次回スキャンした際にこのスプールに即座に一致します。',
    linkedCodesLabel: '一致するコード: {{codes}}',
    linkedCodesRefill: '詰め替え用',
