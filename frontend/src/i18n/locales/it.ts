export default {
  ...
  settings: {
    ...
    barcodeScan: {
      title: 'Ricerca codice a barre per aggiunta',
      enableLookup: 'Cerca online i codici a barre scansionati',
      enableLookupDesc: "Interroga l'Open Filament Database e SpoolmanDB-Community della community quando un codice a barre scansionato non è già nel tuo inventario. Disattiva per abbinare solo i codici a barre già scansionati in precedenza — la scansione in sé continua sempre a funzionare.",
      refreshNow: 'Aggiorna database ora',
      databaseRefreshed: 'Open Filament Database aggiornato — {{count}} codici a barre disponibili',
      databaseRefreshFailed: "Aggiornamento dell'Open Filament Database non riuscito",
    },
    ...
    colorCatalog: {
      ...
      syncSpoolmanDbCommunityTooltip: 'Sincronizza da SpoolmanDB-Community (430+ marchi, potrebbe richiedere un minuto)',
  ...
  inventory: {
    ...
    barcodeScan: {
      scanButton: 'Scansiona codice a barre',
      title: 'Scansiona codice a barre',
      tabScan: 'Scansiona',
      tabPhoto: "Foto dell'etichetta",
      tabManual: 'Inserimento manuale',
      scanHint: "Allinea il codice a barre all'interno del riquadro",
      ...
      manualHint: 'Digita il codice a barre o il codice SKU/articolo stampato sulla scatola della bobina',
      manualPlaceholder: 'es. 6938936716785',
      manualInvalid: 'Inserisci un codice a barre UPC-A/EAN-8/EAN-13 valido, oppure un codice SKU/articolo del produttore (almeno 3 caratteri)',
      lookUp: 'Cerca',
      lookingUp: 'Ricerca codice a barre…',
      sourceInventory: 'il tuo inventario',
      sourceOfd: 'la Open Filament Database',
      sourceSpoolmanDbCommunity: 'SpoolmanDB-Community',
      matchedToast: 'Corrispondenza trovata in {{source}}',
      noMatchToast: 'Nessuna corrispondenza trovata — inserisci i dettagli manualmente',
      lookupFailed: 'Ricerca del codice a barre non riuscita',
      ocrReading: "Lettura dell'etichetta…",
      ocrProgress: "Lettura dell'etichetta… {{progress}}",
      ocrNoText: 'Nessun testo trovato — prova con una foto più chiara e più vicina.',
      parsingLabel: "Analisi dell'etichetta…",
      guessedToast: "Dettagli stimati dall'etichetta — verifica",
      ocrFailed: "Lettura dell'etichetta non riuscita",
    },
    ...
    barcodePlaceholder: 'es. 6938936716785',
    barcodeHelp: 'Compilato automaticamente da Scansiona codice a barre. Inseriscine uno manualmente in modo che una futura scansione dello stesso codice corrisponda istantaneamente a questa bobina.',
    linkedCodesLabel: 'Corrisponde anche a: {{codes}}',
    linkedCodesRefill: 'ricarica',
