export default {
  ...
  settings: {
    ...
    barcodeScan: {
      title: 'Busca de código de barras para adicionar',
      enableLookup: 'Buscar códigos de barras escaneados on-line',
      enableLookupDesc: 'Consulta o Open Filament Database e o SpoolmanDB-Community da comunidade quando um código de barras escaneado ainda não está no seu inventário. Desative para corresponder apenas a códigos já escaneados antes — o próprio escaneamento sempre continua funcionando.',
      refreshNow: 'Atualizar banco de dados agora',
      databaseRefreshed: 'Open Filament Database atualizado — {{count}} códigos de barras disponíveis',
      databaseRefreshFailed: 'Falha ao atualizar o Open Filament Database',
    },
    ...
    colorCatalog: {
      ...
      syncSpoolmanDbCommunityTooltip: 'Sincronizar do SpoolmanDB-Community (430+ marcas, pode levar um minuto)',
  ...
  inventory: {
    ...
    barcodeScan: {
      ...
      tabScan: 'Escanear',
      tabPhoto: 'Foto da etiqueta',
      tabManual: 'Entrada manual',
      scanHint: 'Alinhe o código de barras dentro do quadro',
      ...
      manualHint: 'Digite o código de barras ou o SKU/número de artigo impresso na caixa do carretel',
      manualPlaceholder: 'ex. 6938936716785',
      manualInvalid: 'Digite um código de barras UPC-A/EAN-8/EAN-13 válido, ou um SKU/número de artigo do fabricante (3+ caracteres)',
      lookUp: 'Buscar',
      lookingUp: 'Buscando código de barras…',
      sourceInventory: 'seu inventário',
      sourceOfd: 'o Open Filament Database',
      sourceSpoolmanDbCommunity: 'SpoolmanDB-Community',
      matchedToast: 'Correspondência encontrada em {{source}}',
      noMatchToast: 'Nenhuma correspondência encontrada — preencha os detalhes manualmente',
      lookupFailed: 'Falha ao buscar o código de barras',
      ocrReading: 'Lendo etiqueta…',
      ocrProgress: 'Lendo etiqueta… {{progress}}',
      ocrNoText: 'Nenhum texto encontrado — tente uma foto mais nítida e próxima.',
      parsingLabel: 'Analisando etiqueta…',
      guessedToast: 'Detalhes estimados a partir da etiqueta — revise',
      ocrFailed: 'Falha ao ler a etiqueta',
    },
    ...
    barcodeHelp: 'Preenchido automaticamente pelo Escanear código de barras. Digite um manualmente para que um futuro escaneamento do mesmo código corresponda instantaneamente a este carretel.',
    linkedCodesLabel: 'Também corresponde a: {{codes}}',
    linkedCodesRefill: 'refil',
