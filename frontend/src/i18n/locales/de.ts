export default {
  ...
  settings: {
    ...
    barcodeScan: {
      title: 'Barcode-Scan zum Hinzufügen',
      enableLookup: 'Gescannte Barcodes online nachschlagen',
      enableLookupDesc: 'Fragt die Open Filament Database und SpoolmanDB-Community der Community ab, wenn ein gescannter Barcode noch nicht im eigenen Bestand ist. Deaktivieren, um nur bereits gescannte Barcodes abzugleichen — das Scannen selbst funktioniert immer.',
      refreshNow: 'Datenbank jetzt aktualisieren',
      databaseRefreshed: 'Open Filament Database aktualisiert — {{count}} Barcodes verfügbar',
      databaseRefreshFailed: 'Aktualisierung der Open Filament Database fehlgeschlagen',
    },
    ...
    colorCatalog: {
      ...
      syncSpoolmanDbCommunityTooltip: 'Von SpoolmanDB-Community synchronisieren (430+ Marken)',
  ...
  inventory: {
    ...
    barcodeScan: {
      ...
      tabScan: 'Scannen',
      tabPhoto: 'Foto des Etiketts',
      tabManual: 'Manuelle Eingabe',
      scanHint: 'Richte den Barcode innerhalb des Rahmens aus',
      ...
      manualHint: 'Gib den Barcode oder die Artikel-/SKU-Nummer auf der Spulenverpackung ein',
      manualPlaceholder: 'z. B. 6938936716785',
      manualInvalid: 'Gib einen gültigen UPC-A-/EAN-8-/EAN-13-Barcode oder eine Hersteller-Artikelnummer/SKU ein (mind. 3 Zeichen)',
      lookUp: 'Nachschlagen',
      lookingUp: 'Barcode wird nachgeschlagen…',
      sourceInventory: 'deinem Bestand',
      sourceOfd: 'der Open Filament Database',
      sourceSpoolmanDbCommunity: 'SpoolmanDB-Community',
      matchedToast: 'Treffer aus {{source}}',
      noMatchToast: 'Kein Treffer gefunden — bitte Angaben manuell ausfüllen',
      lookupFailed: 'Barcode-Suche fehlgeschlagen',
      ocrReading: 'Etikett wird gelesen…',
      ocrProgress: 'Etikett wird gelesen… {{progress}}',
      ocrNoText: 'Kein Text gefunden — versuche ein schärferes, näheres Foto.',
      parsingLabel: 'Etikett wird ausgewertet…',
      guessedToast: 'Angaben aus dem Etikett geschätzt — bitte überprüfen',
      ocrFailed: 'Lesen des Etiketts fehlgeschlagen',
    },
    ...
    barcode: 'Barcode',
    barcodePlaceholder: 'z. B. 6938936716785',
    barcodeHelp: 'Wird automatisch durch Barcode scannen ausgefüllt. Gib einen manuell ein, damit ein späterer Scan desselben Codes diese Spule sofort zuordnet.',
    linkedCodesLabel: 'Passt auch zu: {{codes}}',
    linkedCodesRefill: 'Nachfüllpackung',
