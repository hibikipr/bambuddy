export default {
  ...
  settings: {
    ...
    barcodeScan: {
      title: '스캔하여 추가 바코드 조회',
      enableLookup: '스캔한 바코드를 온라인에서 조회',
      enableLookupDesc: '스캔한 바코드가 아직 재고에 없을 때 커뮤니티 Open Filament Database와 SpoolmanDB-Community를 조회합니다. 이전에 스캔한 바코드만 일치시키려면 꺼두세요 — 스캔 기능 자체는 항상 작동합니다.',
      refreshNow: '지금 데이터베이스 새로고침',
      databaseRefreshed: 'Open Filament Database가 새로고침되었습니다 — {{count}}개의 바코드 사용 가능',
      databaseRefreshFailed: 'Open Filament Database 새로고침에 실패했습니다',
    },
    ...
    colorCatalog: {
      ...
      syncSpoolmanDbCommunityTooltip: 'SpoolmanDB-Community에서 동기화 (430개 이상 브랜드, 약 1분 소요)',
  ...
  inventory: {
    ...
    barcodeScan: {
      ...
      takePhoto: '사진 촬영',
      choosePhoto: '사진 선택',
      manualHint: '스풀 상자에 인쇄된 바코드 또는 제조사 SKU/품번을 입력하세요',
      manualPlaceholder: '예: 6938936716785',
      manualInvalid: '유효한 UPC-A/EAN-8/EAN-13 바코드 또는 제조사 SKU/품번(3자 이상)을 입력하세요',
      lookUp: '조회',
      lookingUp: '바코드 조회 중…',
      sourceInventory: '내 재고',
      sourceOfd: 'Open Filament Database',
      sourceSpoolmanDbCommunity: 'SpoolmanDB-Community',
      matchedToast: '{{source}}에서 일치 항목을 찾았습니다',
      noMatchToast: '일치하는 항목이 없습니다 — 세부 정보를 직접 입력하세요',
      lookupFailed: '바코드 조회에 실패했습니다',
      ocrReading: '라벨을 읽는 중…',
      ocrProgress: '라벨을 읽는 중… {{progress}}',
      ocrNoText: '텍스트를 찾을 수 없습니다 — 더 선명하고 가까운 사진을 시도하세요.',
      parsingLabel: '라벨을 분석하는 중…',
      guessedToast: '라벨에서 세부 정보를 추정했습니다 — 검토해 주세요',
      ocrFailed: '라벨 읽기에 실패했습니다',
    },
    addSpool: '스풀 추가',
    editSpool: '스풀 편집',
    copySpool: '스풀 복사',
    ...
    costPerKg: 'kg당 비용',
    barcode: '바코드',
    barcodePlaceholder: '예: 6938936716785',
    barcodeHelp: '바코드 스캔으로 자동 입력됩니다. 나중에 동일한 코드를 스캔했을 때 이 스풀과 즉시 일치하도록 수동으로 입력하세요.',
    linkedCodesLabel: '다음과도 일치: {{codes}}',
    linkedCodesRefill: '리필',
