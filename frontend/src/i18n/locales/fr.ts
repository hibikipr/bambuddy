export default {
  ...
  settings: {
    ...
    barcodeScan: {
      title: 'Recherche de code-barres pour ajout',
      enableLookup: 'Rechercher les codes-barres scannés en ligne',
      enableLookupDesc: "Interroge l'Open Filament Database et SpoolmanDB-Community communautaires lorsqu'un code-barres scanné n'est pas déjà dans votre inventaire. Désactivez pour ne faire correspondre que les codes-barres déjà scannés — le scan lui-même continue toujours de fonctionner.",
      refreshNow: 'Actualiser la base de données maintenant',
      databaseRefreshed: 'Open Filament Database actualisée — {{count}} codes-barres disponibles',
      databaseRefreshFailed: "Échec de l'actualisation de l'Open Filament Database",
    },
    ...
    colorCatalog: {
      ...
      syncSpoolmanDbCommunityTooltip: 'Sync depuis SpoolmanDB-Community (430+ marques, peut être long)',
  ...
  inventory: {
    ...
    barcodeScan: {
      scanButton: 'Scanner un code-barres',
      title: 'Scanner un code-barres',
      tabScan: 'Scanner',
      tabPhoto: "Photo de l'étiquette",
      ...
      manualHint: "Saisissez le code-barres ou le SKU/numéro d'article imprimé sur la boîte de la bobine",
      manualPlaceholder: 'ex. 6938936716785',
      manualInvalid: "Saisissez un code-barres UPC-A/EAN-8/EAN-13 valide, ou un SKU/numéro d'article du fabricant (3 caractères ou plus)",
      lookUp: 'Rechercher',
      lookingUp: 'Recherche du code-barres…',
      sourceInventory: 'votre inventaire',
      sourceOfd: 'la Open Filament Database',
      sourceSpoolmanDbCommunity: 'SpoolmanDB-Community',
      matchedToast: 'Correspondance trouvée dans {{source}}',
      noMatchToast: 'Aucune correspondance trouvée — renseignez les détails manuellement',
      lookupFailed: 'Échec de la recherche du code-barres',
      ocrReading: "Lecture de l'étiquette…",
      ocrProgress: "Lecture de l'étiquette… {{progress}}",
      ocrNoText: 'Aucun texte trouvé — essayez une photo plus nette et plus proche.',
      parsingLabel: "Analyse de l'étiquette…",
      guessedToast: "Détails estimés à partir de l'étiquette — veuillez vérifier",
      ocrFailed: "Échec de la lecture de l'étiquette",
    },
    ...
    barcode: 'Code-barres',
    barcodePlaceholder: 'ex. 6938936716785',
    barcodeHelp: "Rempli automatiquement par Scanner un code-barres. Saisissez-en un manuellement pour qu'un futur scan du même code corresponde instantanément à cette bobine.",
    linkedCodesLabel: 'Correspond aussi à : {{codes}}',
    linkedCodesRefill: 'recharge',
