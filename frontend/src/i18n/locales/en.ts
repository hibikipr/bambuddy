export default {
  ...
  settings: {
    ...
    barcodeScan: {
      title: 'Scan-to-Add Barcode Lookup',
      enableLookup: 'Look up scanned barcodes online',
      enableLookupDesc: 'Query the community Open Filament Database and SpoolmanDB-Community when a scanned barcode isn\'t already in your inventory. Turn off to only match barcodes you\'ve scanned before — scanning itself always keeps working.',
      refreshNow: 'Refresh database now',
      databaseRefreshed: 'Open Filament Database refreshed — {{count}} barcodes available',
      databaseRefreshFailed: 'Failed to refresh the Open Filament Database',
    },
    ...
    colorCatalog: {
      ...
      syncSpoolmanDbCommunityTooltip: 'Sync from SpoolmanDB-Community (430+ brands, may take a minute)',
  ...
  inventory: {
    ...
    barcodeScan: {
      ...
      manualHint: 'Type the barcode or SKU/article number printed on the spool box',
      manualPlaceholder: 'e.g. 6938936716785',
      manualInvalid: 'Enter a valid UPC-A/EAN-8/EAN-13 barcode, or a manufacturer SKU/article number (3+ characters)',
      lookUp: 'Look Up',
      lookingUp: 'Looking up barcode…',
      sourceInventory: 'your inventory',
      sourceOfd: 'the Open Filament Database',
      sourceSpoolmanDbCommunity: 'SpoolmanDB-Community',
      matchedToast: 'Matched from {{source}}',
      noMatchToast: 'No match found — fill in the details manually',
      lookupFailed: 'Barcode lookup failed',
      ocrReading: 'Reading label…',
      ocrProgress: 'Reading label… {{progress}}',
      ocrNoText: 'No text found — try a clearer, closer photo.',
      parsingLabel: 'Parsing label…',
      guessedToast: 'Guessed details from the label — please review',
      ocrFailed: 'Reading the label failed',
    },
    addSpool: 'Add Spool',
    ...
    barcode: 'Barcode',
    barcodePlaceholder: 'e.g. 6938936716785',
    barcodeHelp: 'Filled in automatically by Scan Barcode. Enter one manually so a future scan of the same code matches this spool instantly.',
    linkedCodesLabel: 'Also matches: {{codes}}',
    linkedCodesRefill: 'refill',
