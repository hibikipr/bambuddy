export default {
  ...
  settings: {
    ...
    barcodeScan: {
      title: 'Tarayarak Ekleme Barkod Sorgusu',
      enableLookup: 'Taranan barkodları çevrimiçi sorgula',
      enableLookupDesc: 'Taranan bir barkod envanterinizde henüz yoksa topluluğun Open Filament Database ve SpoolmanDB-Community\'sini sorgular. Yalnızca daha önce taranmış barkodlarla eşleştirmek için kapatın — taramanın kendisi her zaman çalışmaya devam eder.',
      refreshNow: 'Veritabanını Şimdi Yenile',
      databaseRefreshed: 'Open Filament Database yenilendi — {{count}} barkod kullanılabilir',
      databaseRefreshFailed: 'Open Filament Database yenilenemedi',
    },
    ...
    colorCatalog: {
      ...
      syncSpoolmanDbCommunityTooltip: "SpoolmanDB-Community'den senkronize et (430+ marka, bir dakika sürebilir)",
  ...
  inventory: {
    ...
    barcodeScan: {
      ...
      title: 'Barkod Tara',
      tabScan: 'Tara',
      tabPhoto: 'Etiket Fotoğrafı',
      tabManual: 'Manuel Giriş',
      scanHint: 'Barkodu çerçeve içine hizalayın',
      ...
      manualHint: 'Makara kutusuna basılı barkodu veya üretici SKU/ürün numarasını girin',
      manualPlaceholder: 'örn. 6938936716785',
      manualInvalid: 'Geçerli bir UPC-A/EAN-8/EAN-13 barkodu veya üretici SKU/ürün numarası girin (en az 3 karakter)',
      lookUp: 'Ara',
      lookingUp: 'Barkod aranıyor…',
      sourceInventory: 'envanteriniz',
      sourceOfd: 'Open Filament Database',
      sourceSpoolmanDbCommunity: 'SpoolmanDB-Community',
      matchedToast: '{{source}} üzerinden eşleşme bulundu',
      noMatchToast: 'Eşleşme bulunamadı — lütfen ayrıntıları manuel olarak girin',
      lookupFailed: 'Barkod arama başarısız oldu',
      ocrReading: 'Etiket okunuyor…',
      ocrProgress: 'Etiket okunuyor… {{progress}}',
      ocrNoText: 'Metin bulunamadı — daha net ve yakın bir fotoğraf deneyin.',
      parsingLabel: 'Etiket ayrıştırılıyor…',
      guessedToast: 'Ayrıntılar etiketten tahmin edildi — lütfen gözden geçirin',
      ocrFailed: 'Etiket okunamadı',
    },
    ...
    barcode: 'Barkod',
    barcodePlaceholder: 'örn. 6938936716785',
    barcodeHelp: 'Barkod Tara tarafından otomatik olarak doldurulur. Aynı kodun daha sonra taranmasının bu makarayla anında eşleşmesi için manuel olarak bir tane girin.',
    linkedCodesLabel: 'Ayrıca şunlarla eşleşiyor: {{codes}}',
    linkedCodesRefill: 'yeniden dolum',
